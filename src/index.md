...
1Der Webmontag Bonn ist ein Zusammentreffen webaffiner Menschen, die sich zu den aktuellen Entwicklungen im Web austauschen und bei einem Kaltgetränk Kontakte kn&uuml;pfen m&ouml;chten. In der Regel gibt es ein bis zwei Vortr&auml;ge &ndash; Alle sind eingeladen, sich einzubringen. Bitte k&uuml;ndigt euren Talk im Vorfeld [hier](mailto:welcome@wmbn.de) an, das hilft uns ungemein bei der Koordination. Eine **[Themen-Wunschliste findet ihr hier](/vortrags-wunschliste/)**.  
